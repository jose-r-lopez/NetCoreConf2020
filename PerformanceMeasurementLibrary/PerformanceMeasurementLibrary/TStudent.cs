...
{
    /// <summary>
    /// Implementations of the T-Student distribution
    /// (c) James McCaffrey:
    /// https://docs.microsoft.com/es-es/archive/msdn-magazine/2015/november/test-run-the-t-test-using-csharp
    /// </summary>
    public static class TStudent
    {
        /// <summary>
        /// T-Student distribution implementation adapted from ACM algorithm 395
        /// for large degrees of freedom (int or double)
        /// </summary>
        /// <param name="t">Random variable</param>
        ...
        /// <summary>
        /// T-Student distribution implementation adapted from ACM algorithm 395
        /// for small degrees of freedom (int only)
        /// </summary>
        /// <param name="t">Random variable</param>
        /// <param name="df">Degrees of freedom</param>
        /// <returns>2-tail probability</returns>
        ...
        /// <summary>
        /// Auxiliar Gauss function to calculate T-Student distribution values
        /// based on ACM Algorithm #209
        /// </summary>
        /// <param name="z">z-value (-inf to +inf)</param>
        /// <returns>p under Normal curve from -inf to z.
        /// e.g., if z = 0.0, function returns 0.5000</returns>
